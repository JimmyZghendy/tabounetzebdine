...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { en: "Mixed Nuts", ar: "بزورات", price: "150,000" },
      { en: "Nuts Xtra", ar: " اكتسرا بزورات", price: "300,000" },
      { en: "Cracked Almonds", ar: "لوز مكسور", price: "200,000" },
      { en: "Carrots", ar: "جزر", price: "100,000" },
      { en: "Lupini Beans (Termos)", ar: "ترمس", price: "100,000" },
    ],
  },
  {
    id: "fekhara",
  ...
  },
  {
    ...
    items: [
      ...
      { en: "Beer Light", ar: "بيرة لايت", price: "300,000" },
      { en: "Large Water", ar: "مياه كبير", price: "100,000" },
      { en: "Small Water", ar: "مياه صغير", price: "50,000" },
      { en: "Sparkling Water", ar: "مياه فوارة", price: "150,000" },
